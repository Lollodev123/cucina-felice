...
window.SEED_RECIPES = [
  ...
  },
  {
    ...
    colors: ["rosa", "verde", "giallo"], aromas: ["limone", "rosmarino"], moods: ["mare", "una-teglia", "leggero"],
  ...
  },
  {
    ...
    colors: ["rosso", "bianco", "giallo"], aromas: ["limone", "prezzemolo"], moods: ["mare", "una-teglia", "profumato"],
  ...
  },
  {
    ...
    colors: ["verde", "giallo", "bianco"], aromas: ["limone", "prezzemolo"], moods: ["mare", "sfizioso"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 40, difficulty: "facile",
    colors: ["arancione", "bianco"], aromas: ["salvia", "rosmarino"], moods: ["comfort", "colorato"],
  ...
  /* ---------- PADELLA VELOCE (< 20 minuti) ---------- */
  {
    ...
    colors: ["rosso", "verde", "bianco"], aromas: ["pepe", "limone"], moods: ["veloce", "classico-romano", "proteico"],
  ...
  },
  {
    ...
    colors: ["giallo", "verde"], aromas: ["limone", "prezzemolo"], moods: ["veloce", "comfort"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 20, difficulty: "facilissima",
    colors: ["rosso", "giallo", "verde"], aromas: ["pepe", "origano"], moods: ["veloce", "colorato", "proteico"],
  ...
  },
  {
    ...
    colors: ["rosa", "verde", "bianco"], aromas: ["limone", "prezzemolo", "peperoncino"], moods: ["mare", "veloce", "fresco"],
  ...
  },
  {
    ...
    colors: ["giallo", "verde", "bianco"], aromas: ["limone", "prezzemolo"], moods: ["comfort", "profumato"],
  ...
  /* ---------- PESCE ---------- */
  {
    ...
    region: "Italia", servings: 2, timeMin: 35, difficulty: "facile",
    colors: ["verde", "bianco"], aromas: ["limone", "prezzemolo"], moods: ["mare", "leggero"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facile",
    colors: ["rosso", "giallo", "rosa"], aromas: ["pepe", "limone"], moods: ["mare", "sfizioso", "proteico"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["rosa", "verde", "bianco"], aromas: ["limone"], moods: ["leggero", "mare", "fresco"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 35, difficulty: "facilissima",
    colors: ["verde", "bianco"], aromas: ["limone", "prezzemolo"], moods: ["mare", "una-teglia", "leggero"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 30, difficulty: "facile",
    colors: ["rosa", "giallo", "verde"], aromas: ["limone", "prezzemolo"], moods: ["mare", "sfizioso"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["verde", "arancione", "giallo"], aromas: ["prezzemolo", "basilico"], moods: ["profumato", "leggero"],
  ...
  /* ---------- BOWL / INSALATE FREDDE ---------- */
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["rosso", "verde", "bianco"], aromas: ["basilico", "limone"], moods: ["fresco", "veloce", "colorato"],
  ...
  {
    id: "insalata-tonno-patate-olive",
    title: "Insalata di tonno, patate e olive",
    emoji: "🥗",
    story: "Patate tiepide, tonno e olive saporite: il piatto unico furbo della dispensa.",
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["bianco", "verde", "marrone"], aromas: ["prezzemolo", "limone"], moods: ["fresco", "veloce"],
    ingredientKeys: ["tonno", "patate", "olive", "insalata", "limone"],
    protein: { name: "Tonno", emoji: "🐟" },
    carb: { name: "Patate", emoji: "🥔" },
    veggie: { name: "Insalata + olive", emoji: "🥗" },
    ingredients: [
      { name: "Tonno al naturale", qty: "160 g", emoji: "🐟" },
      { name: "Patate", qty: "300 g", emoji: "🥔" },
      { name: "Olive", qty: "1 manciata", emoji: "🫒" },
      { name: "Insalata", qty: "1 cespo", emoji: "🥗" },
      { name: "Olio EVO + limone", qty: "q.b.", emoji: "🍋" }
    ],
    steps: [
      { text: "Lessa le patate, falle intiepidire e taglia a cubi.", emoji: "🥔", timerMin: 15 },
      { text: "Sgocciola il tonno.", emoji: "🐟" },
      { text: "Unisci patate, tonno, olive, insalata.", emoji: "🥣" },
      { text: "Condisci con olio, limone, sale, prezzemolo.", emoji: "🍋" },
      { text: "Mescola e servi.", emoji: "🍽️" }
    ],
    finalEmoji: "🍽️",
    lowFodmap: "Olive, lattuga, patate, tonno low-FODMAP. Senza latticini, senza aglio."
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 30, difficulty: "facile",
    colors: ["verde", "rosa", "bianco"], aromas: ["limone", "menta"], moods: ["fresco", "leggero", "colorato"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["giallo", "rosso", "verde"], aromas: ["limone", "prezzemolo"], moods: ["fresco", "leggero", "veloce"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["arancione", "bianco", "verde"], aromas: ["limone", "prezzemolo"], moods: ["fresco", "leggero", "colorato"],
  ...
  {
    id: "saltimbocca-patate-spinaci",
    title: "Saltimbocca alla romana con patate e spinaci",
    emoji: "🥩",
    story: "Vitello, prosciutto e salvia: tre ingredienti, un classico romano che 'salta in bocca' in 15 minuti.",
    region: "Roma / Lazio", servings: 2, timeMin: 25, difficulty: "facile",
    colors: ["marrone", "verde", "bianco"], aromas: ["salvia"], moods: ["classico-romano", "comfort", "proteico"],
    ingredientKeys: ["vitello", "prosciutto", "patate", "spinaci", "salvia"],
    protein: { name: "Vitello + prosciutto", emoji: "🥩" },
    carb: { name: "Patate", emoji: "🥔" },
    veggie: { name: "Spinaci", emoji: "🥬" },
    ingredients: [
      { name: "Fettine di vitello", qty: "4", emoji: "🥩" },
    ...
    steps: [
      ...
      { text: "Cuoci in padella con olio, 2 min per lato.", emoji: "🍳", timerMin: 4 },
      { text: "Sfuma con poca acqua per la salsina.", emoji: "🥣" },
      { text: "Salta gli spinaci e servi con le patate.", emoji: "🍽️" }
    ],
    finalEmoji: "🍽️",
    lowFodmap: "Vitello, prosciutto, patate, spinaci low-FODMAP. Senza latticini, senza aglio/cipolla."
  },
  {
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 30, difficulty: "facile",
    colors: ["rosso", "verde", "giallo"], aromas: ["pepe", "rosmarino"], moods: ["sfizioso", "proteico", "classico-romano"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facile",
    colors: ["rosso", "bianco", "rosa"], aromas: ["limone", "origano"], moods: ["mare", "proteico", "fresco"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facilissima",
    colors: ["giallo", "verde", "bianco"], aromas: ["curcuma", "zenzero"], moods: ["colorato", "profumato", "veloce"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 35, difficulty: "facilissima",
    colors: ["bianco", "verde", "giallo"], aromas: ["limone", "prezzemolo"], moods: ["mare", "leggero", "una-teglia"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 20, difficulty: "facilissima",
    colors: ["rosso", "verde", "rosa"], aromas: ["basilico"], moods: ["fresco", "veloce", "colorato"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 35, difficulty: "facilissima",
    colors: ["rosa", "verde", "bianco"], aromas: ["limone", "timo"], moods: ["mare", "leggero", "una-teglia"],
  ...
  },
  {
    ...
    region: "Italia", servings: 2, timeMin: 25, difficulty: "facile",
    colors: ["arancione", "verde", "marrone"], aromas: ["zenzero"], moods: ["veloce", "colorato", "profumato"],
